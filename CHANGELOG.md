...
- Red, Blue and Yellow dark themes now use a matte dark grey background instead of near black.
- Cards are now clearly separated from the background on all dark themes.
- Reduced the yellow tint on the Yellow dark theme background.
- Added a View Summary button to the home screen after completing a split workout.
